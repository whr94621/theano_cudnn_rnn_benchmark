...
from dl4mt_layers.layers import param_init_gru
from dl4mt_layers.layers import gru_layer_no_gemm_fusion as gru_layer
...
print("Non-CuDNN unidirectional GRU withoud GEMM fusion")
